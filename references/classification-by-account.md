...
For new archives, first decide whether AI and HR/OD/talent are jointly central to the article's thesis or practical method. If so, use `00知识库/AI与HR应用/` regardless of the WeChat account (`nickname` / `nick_name`). A passing mention of either topic does not qualify. The account table supplies defaults for ambiguous articles; dated paths below record historical placements and do not override this rule. Explicit user destinations and the dedicated 卡兹克 author collection take priority.

## Known Accounts

| Account (nickname) | Default destination | Notes |
| --- | --- | --- |
| `HR实名俱乐部` | `00知识库/HR知识/` | Author is 陈祖鑫. Covers HR tools, AI in HR, HR trends. HR-only articles stay here; new AI + HR articles go to AI与HR应用. AI时代领导力/组织重塑/干部管理类解读（如《周鸿祎谈AI时代的领导力与组织重塑》2026-08-17）→ 组织发展. 大厂AI native团队实践报道（如《淘天集团：AI native团队的构想与实践》2026-08-19）→ 组织发展. HR职业转型/新角色类（如《对比FDE，我觉得Builder更像是HR的下一站》2026-08-21）→ 人才发展（与既有 FDE/Builder 文章同子类）. ⚠️ 文末常有线下活动推广块（「✅最新AI线下活动日程」或「【最近线下活动】」+ 城市+日期+扫码报名+二维码）→ 截断删除；其上方「> 文章链接」推荐列表保留. |
| `AI与组织领导力跃迁` | `00知识库/HR知识/` | Author 罗明. Covers org development, change management, leadership, compensation/governance. Subcategory by topic: 组织发展, HR的AI应用, 人才发展 (leadership/IDP/competency pieces like 领导力发展), or 薪酬绩效 (compensation/executive-incentive pieces like 集团薪酬改革, and 销售激励方案类 like 《销售激励，从"老板不满意、销售不买账"到"精准匹配"的方法论》 2026-08-17). 组织效能系列（《做好了一件事，还远不够，效能提升需要组织效能魔方》2026-08-24，六面框架：战略共识/组织耦合/能力进化/投产精准/效能运用/效能监控）→ 组织发展，与 人效/组织能力 文章同子类. 组织效能/组织有效性框架类（如《做好了一件事，还远不够，效能提升需要组织效能魔方》2026-08-24, 组织效能系列·第二篇）→ **组织发展**（与既有 美的集团组织与人才效能指标体系 同子类）。组织效能系列·第三篇《战略意图与战略损益表，让事想清楚，让团队可以做出来的几个方法》(2026-08-26, 拆解第一面「战略共识」：战略解码从业务开始/创新焦点/战略意图排序/组织能力扫描/投产解码/战略损益账三张纸) → **组织发展**（同第二篇先例）。组织效能系列·第四篇《拉开差距的从来不是人数，是组织与能力》(2026-09-05, 拆解第二三面「组织与能力」：组织体检四维扫描/敏捷创新五种高频尝试/知识传承理念-制度-工具三层/面向未来五大能力+技能定价/劳动力规划从算人头到拆技能/组织资本·把文化做成产品) → **组织发展**（同系列先例）。组织效能系列·第五篇《组织效能：投产与运营，钱花得对不对，比花多少更重要》(2026-09-10, 收官篇拆后三面投产精准/效能运用/效能监控：投产分析框架九问/薪酬支付天平从能力转向岗位价值/资源分配四要素/薪酬总额五种模式/效能是运营不是项目) → **组织发展**（同系列先例——正文近半是薪酬主题（薪酬支付、资源分配、薪酬总额）仍按系列归组织发展，不归薪酬绩效；第六篇及后续同系列照此办理）。 销售管理突围系列（《红利退潮之后，销售管理的五个死结》2026-09-16，第一篇：五个死结「目标/激励/队伍/业务发展/人才发展」+ 定目标三新命题）→ **薪酬绩效**（正文主体是销售目标设定、指标制定四种方式、过程指标、资源配额——绩效/KPI/激励域，与同账号《销售激励…》先例一致；系列后续「激励怎么设计」篇同归薪酬绩效）。**销售管理突围·第二篇《目标不是算出来的，激励也不是加两个点》(2026-09-21, 激励的两个维度/农夫与猎人角色/佣金与奖金六因素/五类激励曲线/两套激励逻辑/压货判定与惩罚/把过程装进奖金) → 薪酬绩效**（先例确认）。 |
...
| `数字生命卡兹克` | `00知识库/卡兹克/` | Author is 卡兹克. Check subfolder: AI资讯 / claude code / codex / prompt / skills / workbuddy. ⚠️ **心得/观点/总结类文章（创业心得、AI使用心得、人才观等，不属于任何工具子分类）→ 卡兹克根目录**，且**不入入口页**——入口页只列子分类文章（verified 2026-08-20: 根目录已有《用AI的这三年，想跟你分享这9条心得。》《AI时代的人才，我觉得最重要的是这6点特质。》《上周做了场内部分享…》《创业2年半后，想跟你分享关于AI组织的这7点心得。》均无入口链接）。根目录文章 frontmatter tags 加 `khazix`（`- article / - wechat / - khazix`，参考《用AI的这三年》2026-02 的 frontmatter）。规则：工具教程→对应子文件夹；心得/观点/创业分享→根目录。**人物故事/采访随笔类（如《两个16岁的高中生，共享了自己的显卡和API，想让全校同学都免费用上AI。》2026-08-24——两位高中生自购显卡创办炼丹社、搭FreeAPI共享站让全校免费用AI，非工具教程非资讯）→ 根目录**，同样不入入口页、tags 加 khazix。**Prompt 合集/模板类文章（如《都Agent时代了，我还是想分享给你这12个我最常用的Prompt。》2026-08-21）→ prompt 子目录**——可复制即用的模板属于工具教程类，不是心得类（区别于 9条心得/6点特质 等 numbered-list reflections 与人物故事随笔）。**模型发布/评测解读类（GPT-6 Astra全面解析 2026-09-04、GPT-5.6深夜上线、Claude Opus 5深夜发布、GLM-5.3-Flash 等）→ AI资讯 子目录**——产品发布点评属于资讯/评论，不是工具教程，也不是心得随笔（与已有 4 篇同目录先例一致）。**实测/上手评测类同归 AI资讯**（《实测GPT-6 Astra：曾经的那个OpenAI，回来了。》2026-09-05，作者 卡兹克、AIZ小朱——subscription 推送后的 hands-on 体验长评，与同日的全面解析是两篇不同文章、同一子目录）→ AI资讯。Co-authored posts: frontmatter `author` keeps both names joined with `、`（如 `卡兹克、AIZ小朱`），footer `> / 作者：卡兹克、AIZ小朱` line is kept verbatim. |
| `AI组织进化论` | `00知识库/AI知识/` | Emits `var nickname = htmlDecode("AI组织进化论")` — grep raw HTML for the htmlDecode pattern when plain `var nickname = "..."` comes back empty; `<meta name="author">` also populated. Subcategory by topic: org/team AI-agent case studies → AI应用 (precedent: 《干活1天，交接却要18天：麦肯锡揭示企业最贵"协调税"》2026-09-19, agentic AI 削减部门交接等待/流程改造 → AI应用). ⚠️ This account frequently interprets **McKinsey HR-transformation reports** (三支柱→产品与平台, HR work automation by 2030, agentic-era HR). For new archives, place these in AI与HR应用 when AI and HR are jointly central; historical copies may remain in AI知识/AI应用 — near-duplicate-titled McKinsey HR articles from other accounts (麦肯锡, HR实名俱乐部) live in `00知识库/HR知识/`. When the user sends such a link, run the PROPFIND duplicate check against AI与HR应用, AI知识, and HR知识 (decode hrefs first) so a same-title repost in the other folder isn't missed. |
...
| `车厘子随便写写` | `00知识库/HR知识/` | Author 车厘子. Publishes the 出海组织观察日记 series (第一季 组织观察；第二季《AI时代组织观察》2026-08 开篇《告别外部常模：AI时代，我们如何重新定义"人才"？》→ 组织发展) → mostly HR知识/组织发展. ⚠️ **既有文章文件本体放在 `00知识库/HR知识/` 根目录；新归档的 AI + HR 文章按主题放 `00知识库/AI与HR应用/`**（出海组织观察日记全系列、AI时代组织观察（1）与（2）均在根目录，不在 组织发展/ 子文件夹）；入口页则登记到 `### 组织发展` 分类（2026-09 verified on 训战 piece）。 ⚠️ `var nickname` IS emitted, but as **`随便写写的地方`** (2026-08 verified) — `<meta name="author">` = `车厘子随便写写` is the reliable account identifier, not the nickname var. 正文段落用行首空格/全角空格/`\xa0` 缩进，提取后需 `re.sub(r'^[ \t\u3000\xa0]+', '', body, flags=re.M)` 清理；列表项常提取为 `N.\n\n内容` 分裂（踩坑复盘/潜在解法/匹配清单），需按 Ordered List Number-Content Split 合并。 |
...
| `Datawhale` | `00知识库/AI知识/` | AI/大数据学习社区（Datawhale干货，正文署名具体成员如 王大鹏，frontmatter author 取署名成员 + 社区名）。不在账号表时按主题归 AI知识：工具/系统搭建保姆教程类（如《我用 Obsidian 搭了一套 Agent 知识系统，保姆教程来了！》2026-08-28）→ **AI工具**（setup guides）；工作流/用法类 → AI使用提效。`var nickname` 正常输出。提取 artifacts 见 wechat-formatting.md「Datawhale Account Artifacts」节。 |
...
1. Honor an explicit user destination and the dedicated 卡兹克 author collection.
2. If AI **and** HR/OD/talent are both essential to the argument or method, use `AI与HR应用/`.
3. Otherwise use the main reader problem: HR-only → `HR知识/`; general AI tools, workflows, and non-HR applications → `AI知识/`; business strategy and company cases → `商业知识/`.
4. Use the account table to resolve genuinely ambiguous cases. Historical examples in the table do not change the destination of a new cross-domain article.
...
### HR知识 subcategories
- **HR的AI应用**: Legacy link to `AI与HR应用入口.md`; do not add new cross-domain articles here
...
### AI与HR应用 subcategories
- **组织与管理**: AI-driven organization design, team forms, leadership, and human-agent collaboration
- **人才与能力**: AI-era talent standards, assessment, recruiting, skills, and workforce planning
- **HR职能与工具**: AI in HR operations, hiring, performance, compensation, and practical HR tools
- **转型实践与理念**: HR role changes, enterprise adoption, change management, and judgment frameworks
...
- `nickname` = `HR实名俱乐部` (HR default)
- Topic = AI applied to recruiting and talent modeling
- Correct for a new archive: `00知识库/AI与HR应用/` under `### 人才与能力`
